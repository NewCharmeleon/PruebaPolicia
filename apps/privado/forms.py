...
class AutoridadForm(ModelForm):
	...
	telefono_laboral = forms.CharField(required=True, validators=[telefono_regex], widget=forms.TextInput(attrs=dict({'class':'form-control input-lg verifca','placeholder':'Telefono Laboral','required':'required', 'style':'text-align: left;'})))
	#telefono_laboral = forms.RegexField
