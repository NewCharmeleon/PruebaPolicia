...
urlpatterns = [
	...
	path('sistema_voto_electronico/', public.sistema_voto_electronico, name='sistema_voto_electronico'),
	path('descargas/', public.descargas, name='descargas'),
	path('dependencias/<int:id>/', public.dependencias, name='dependencias'),
	path('dependencia/<int:id>/ver', public.dependencia, name='dependencia_ver'),
	path('correo/', public.correo, name='correo'),
	path('educacion_fisica_tips/', public.educacion_fisica_tips, name='educacion_fisica_tips'),
	path('educacion_fisica_tips_covid19/', public.educacion_fisica_tips_covid19, name='educacion_fisica_tips_covid19'),
	path('educacion_fisica_tips_tren_superior/', public.educacion_fisica_tips_tren_superior, name='educacion_fisica_tips_tren_superior'),
	...
	path('comunicaciones/', public.comunicaciones, name='comunicaciones'),
	path('educacion_fisica/', public.educacion_fisica, name='educacion_fisica'),
...
##las vistas creadas
handler404 = 'publico.views.pag_404_not_found'
handler500 = 'publico.views.pag_500_error_server'
